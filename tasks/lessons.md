...
1. **Proof-only success is not done.** If Factory2 counts in `scripts/research/factory2/run_factory2_morning_proof.py` but the actual worker/app runtime path still shows `counts_this_hour: 0`, the task is still in progress.
