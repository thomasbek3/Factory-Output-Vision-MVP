...
Moved out of scripts/ so app/services/validation_runner.py does not import
from scripts.* (ADR-compatible layering). The scripts/validation_truth_guard.py
module re-exports this API for existing CLI/test imports.
"""
