    ...
    *,
    ...
    for package_item in package_items:
        ...
        if crop_label == "unclear" or not crop_label:
            ...
            continue
        if crop_label not in TARGET_CLASSES:
        ...
        image_path = dataset_dir / "images" / split / crop_label / f"{_packaged_stem(package_item)}{suffix}"
    ...
    missing_classes = [label for label in TARGET_CLASSES if label_counts[label] == 0]
